platform :apple do
  ...
  lane :_build_tvos do
    ...
    gym(
      ...
      xcargs: "OTHER_CODE_SIGN_FLAGS='--keychain /Users/runner/Library/Keychains/#{ENV["KEYCHAIN"]}-db' TVOS_DEPLOYMENT_TARGET=17.0",
      clean: true,
  ...
  lane :_build_ios do
    ...
    gym(
      ...
      output_name: "#{ENV["SCHEME"]}.ipa",
      xcargs: "OTHER_CODE_SIGN_FLAGS='--keychain /Users/runner/Library/Keychains/#{ENV["KEYCHAIN"]}-db' IPHONEOS_DEPLOYMENT_TARGET=17.0",
  ...
  lane :_build_macos do
    ...
    gym(
      ...
      xcargs: "OTHER_CODE_SIGN_FLAGS='--keychain /Users/runner/Library/Keychains/#{ENV["KEYCHAIN"]}-db' MACOSX_DEPLOYMENT_TARGET=10.15 EFFECTIVE_PLATFORM_NAME=''",
